...
export const IPC = {
  ...
  getProjectSettings: 'project:settings-get',
  setProjectSettings: 'project:settings-set',
  adoptionOptions: 'project:adoption-options',
  adoptProject: 'project:adopt',
  chooseProjectFolder: 'project:choose-folder',
